<div>
    @if($showModal)
        <div class="fixed inset-0 z-50 flex items-center justify-center px-4 py-6">
            ...
            <div class="relative bg-white/95 rounded-2xl shadow-2xl w-full max-w-2xl overflow-hidden ring-1 ring-slate-200">
                <div class="flex items-start justify-between gap-4 p-6 border-b border-slate-200 bg-gradient-to-r from-slate-50 to-white">
                    <div>
